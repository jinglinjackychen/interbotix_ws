...
int main(int argc, char** argv)
{
  ...
  moveit_visual_tools::MoveItVisualTools visual_tools("vx300s/base_link");
  ...
  move_group.setPoseReferenceFrame("vx300s/base_link");
  ...
  ocm.link_name = "vx300s/ee_arm_link";
  ocm.header.frame_id = "vx300s/base_link";
